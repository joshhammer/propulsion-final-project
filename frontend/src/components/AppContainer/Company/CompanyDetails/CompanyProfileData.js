    ...
    render() {
        ...
        return (
            <div className='company-profile-data-container'>
                ...
                <div className='profile-table-element'>
                    <p className="company-element">Postal Code</p>
                ...
                <div className='profile-table-element'>
                    <p className="company-element">Contact Person</p>
                ...
                <div className='profile-table-element'>
                    <p className="company-element">Email</p>
                ...
                <div className='profile-table-element'>
                    <p className="company-element">Bank Name</p>
                ...
                <div className='profile-table-element'>
                    <p className="company-element">Bank IBAN</p>
                ...
                <div className='profile-table-element'>
                    <p className="company-element">Bank BIC</p>
